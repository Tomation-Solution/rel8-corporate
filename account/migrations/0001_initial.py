    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('super_admin', 'Super Admin'), ('members', 'Members'), ('prospective_members', 'Prospective Members')], max_length=25)),
                ('is_superuser', models.BooleanField(default=False)),
                ('matric_number', models.CharField(default='', max_length=1000, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ManyToManyField(blank=True, default=None, to='account.Memeber')),
            ],
        ),
        migrations.CreateModel(
